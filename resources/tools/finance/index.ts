              ...
              },
              {
                properties: {
                  ...
                  operatingCashFlowToCurrentLiabilitiesRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by operating cash flow to current liabilities ratio range [min, max].',
                  },
                  ebitdaInterestExpenseRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by EBITDA to interest expense ratio range [min, max].',
                  },
                  ebitInterestExpenseRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by EBIT to interest expense ratio range [min, max].',
                  },
                  totalRevenue1YrGrowthRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total revenue 1-year growth percentage range [min, max].',
                  },
                  netIncome1YrGrowthRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by net income 1-year growth percentage range [min, max].',
                  },
                  basicEpsContinuingOperationsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by basic EPS from continuing operations range [min, max].',
                  },
                  revenueGrowthPercentYoYQuarterlyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by quarterly revenue growth percentage YoY range [min, max].',
                  },
                  totalRevenueRange: {
                    type: 'array',
                    items: { type: 'number' },
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total revenue LTM range [min, max].',
                  },
                  totalRevenueAnnualMarketCurrencyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total revenue annual in market currency range [min, max].',
                  },
                  totalRevenuePerEmployeeAnnualMarketCurrencyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total revenue per employee annual in market currency range [min, max].',
                  },
                  netEpsBasicRange: {
                    type: 'array',
                    items: { type: 'number' },
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by net EPS basic LTM range [min, max].',
                  },
                  ebitda1YrGrowthRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by EBITDA 1-year growth percentage range [min, max].',
                  },
                  dilutedEps1YrGrowthRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by diluted EPS 1-year growth percentage range [min, max].',
                  },
                  netEpsDilutedRange: {
                    type: 'array',
                    items: { type: 'number' },
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by net EPS diluted LTM range [min, max].',
                  },
                  netIncomeIsRange: {
                    type: 'array',
                    items: { type: 'number' },
                  ...
                  netIncomeIsAnnualMarketCurrencyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by net income annual in market currency range [min, max].',
                  },
                  netIncomePerEmployeeAnnualMarketCurrencyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by net income per employee annual in market currency range [min, max].',
                  },
                  operatingIncomeRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by operating income LTM range [min, max].',
                  },
                  grossProfitRange: {
                    type: 'array',
                    items: { type: 'number' },
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by gross profit LTM range [min, max].',
                  },
                  ebitdaRange: {
                    type: 'array',
                    items: { type: 'number' },
                  ...
                  dilutedEpsContinuingOperationsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by diluted EPS from continuing operations range [min, max].',
                  },
                  ebitRange: {
                    type: 'array',
                    items: { type: 'number' },
                  ...
                  forwardDividendYieldRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by forward dividend yield percentage range [min, max].',
                  },
                  size: {
                    type: 'number',
                    minimum: 1,
                  ...
                  fields: {
                    ...
                    items: {
                      ...
                      enum: [
                        'symbol', 'shortName', 'regularMarketPrice', 'regularMarketChange', 'regularMarketChangePercent', 'marketCap', 'peRatioLtm', 'regularMarketVolume', 'averageDailyVolume3Month', 'fiftyTwoWeekPercentChange', 'beta', 'dividendYield', 'sector', 'industry', 'exchange', 'region',
                        'operatingCashFlowToCurrentLiabilitiesLtm', 'ebitdaInterestExpenseLtm', 'ebitInterestExpenseLtm', 'totalRevenue1YrGrowthPercentLtm', 'netIncome1YrGrowthPercentLtm', 'basicEpsContinuingOperationsLtm', 'revenueGrowthPercentYoYQuarterly', 'totalRevenueLtm', 'totalRevenueAnnualMarketCurrency', 'totalRevenuePerEmployeeAnnualMarketCurrency', 'netEpsBasicLtm', 'ebitda1YrGrowthPercentLtm', 'dilutedEps1YrGrowthPercentLtm', 'netEpsDilutedLtm', 'netIncomeIsLtm', 'netIncomeIsAnnualMarketCurrency', 'netIncomePerEmployeeAnnualMarketCurrency', 'operatingIncomeLtm', 'grossProfitLtm', 'ebitdaLtm', 'dilutedEpsContinuingOperationsLtm', 'ebitLtm', 'forwardDividendYieldPercent'
                      ],
                    },
                    description: 'Specific fields to return in the records.',
                  },
              ...
              },
              {
                properties: {
                  ...
                  bookValueShareRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by book value per share LTM range [min, max].',
                  },
                  totalSharesOutstandingRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total shares outstanding range [min, max].',
                  },
                  totalDebtRange: {
                    type: 'array',
                    items: { type: 'number' },
                  ...
                  totalAssetsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total assets LTM range [min, max].',
                  },
                  totalCashAndShortTermInvestmentsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total cash and short term investments LTM range [min, max].',
                  },
                  totalCurrentAssetsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total current assets LTM range [min, max].',
                  },
                  totalEquityRange: {
                    type: 'array',
                    items: { type: 'number' },
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total equity LTM range [min, max].',
                  },
                  totalCommonSharesOutstandingRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total common shares outstanding LTM range [min, max].',
                  },
                  totalCurrentLiabilitiesRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total current liabilities LTM range [min, max].',
                  },
                  totalCommonEquityRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by total common equity LTM range [min, max].',
                  },
                  fullTimeEmployeesRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by full time employees annual range [min, max].',
                  },
                  cashOnHandQuarterlyMarketCurrencyRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by cash on hand quarterly in market currency range [min, max].',
                  },
                  cashFromOperations1YrGrowthPercentRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by cash from operations 1-year growth percentage LTM range [min, max].',
                  },
                  unleveredFreeCashFlowRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by unlevered free cash flow LTM range [min, max].',
                  },
                  leveredFreeCashFlowRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by levered free cash flow LTM range [min, max].',
                  },
                  leveredFreeCashFlow1YrGrowthPercentRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by levered free cash flow 1-year growth percentage LTM range [min, max].',
                  },
                  dividendPerShareRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by dividend per share LTM range [min, max].',
                  },
                  capitalExpenditureRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by capital expenditure LTM range [min, max].',
                  },
                  forwardDividendPerShareRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by forward dividend per share range [min, max].',
                  },
                  cashFromOperationsRange: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: 'Filter by cash from operations LTM range [min, max].',
                  },
                  size: {
                    type: 'number',
                    minimum: 1,
                  ...
                  sortField: {
                    type: 'string',
                    description: 'Field to sort by (e.g. "marketCap", "totalAssetsLtm", "regularMarketPrice"). Let Yahoo validate.',
                  },
                  sortOrder: {
                    type: 'string',
                    enum: ['asc', 'desc'],
                  ...
                  fields: {
                    ...
                    items: {
                      ...
                      enum: [
                        'symbol', 'shortName', 'regularMarketPrice', 'regularMarketChange', 'regularMarketChangePercent', 'marketCap', 'peRatioLtm', 'regularMarketVolume', 'averageDailyVolume3Month', 'fiftyTwoWeekPercentChange', 'beta', 'dividendYield', 'sector', 'industry', 'exchange', 'region',
                        'bookValueShareLtm', 'totalSharesOutstanding', 'totalDebtLtm', 'totalAssetsLtm', 'totalCashAndShortTermInvestmentsLtm', 'totalCurrentAssetsLtm', 'totalEquityLtm', 'totalCommonSharesOutstandingLtm', 'totalCurrentLiabilitiesLtm', 'totalCommonEquityLtm', 'fullTimeEmployees', 'cashOnHandQuarterlyMarketCurrency', 'cashFromOperations1YrGrowthPercentLtm', 'unleveredFreeCashFlowLtm', 'leveredFreeCashFlowLtm', 'leveredFreeCashFlow1YrGrowthPercentLtm', 'dividendPerShareLtm', 'capitalExpenditureLtm', 'forwardDividendPerShare', 'cashFromOperationsLtm'
                      ],
                    },
                    description: 'Specific fields to return in the records.',
                  },
