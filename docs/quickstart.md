...
```ts
import { createCopilotz } from "jsr:@copilotz/copilotz@^0.63.7";
import { corePlugin, message } from "jsr:@copilotz/copilotz@^0.63.7/core";
...
```ts
import { defineLlmCredential } from "jsr:@copilotz/copilotz@^0.63.7/llm";
...
import {
  createToolsPlugin,
  defineTool,
} from "jsr:@copilotz/copilotz@^0.63.7/tools";
