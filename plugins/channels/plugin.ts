...
import { channelEgressAction, channelIngressAction } from "./actions.ts";
import { channelBindingCollection } from "./collection.ts";
import {
...
export const CHANNELS_PLUGIN_VERSION = "0.62.0";
