...
CREATE INDEX IF NOT EXISTS "idx_messages_thread_id_created_at" ON "messages" ("threadId", "createdAt");
...
CREATE INDEX IF NOT EXISTS "idx_agents_external_id" ON "agents" ("externalId");
CREATE INDEX IF NOT EXISTS "idx_apis_name" ON "apis" ("name");
CREATE INDEX IF NOT EXISTS "idx_apis_external_id" ON "apis" ("externalId");
CREATE INDEX IF NOT EXISTS "idx_tools_external_id" ON "tools" ("externalId");
CREATE INDEX IF NOT EXISTS "idx_users_external_id" ON "users" ("externalId");
