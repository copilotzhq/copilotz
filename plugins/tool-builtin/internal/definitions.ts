/** Shared execution implementations for the hand-authored built-in Tools.
 *
 * @module
 */
...
import type { ActionContext, ActionSchema } from "@copilotz/copilotz/actions";
import type { BuiltInCoreToolId } from "../plugin.ts";
...
export function waitDefinition(
...
export function saveAssetDefinition(): BuiltInToolDefinition {
...
export function fetchAssetDefinition(): BuiltInToolDefinition {
...
export function updateMyMemoryDefinition(): BuiltInToolDefinition {
...
export function updateUserMemoryDefinition(
  now: () => Date,
): BuiltInToolDefinition {
...
export function createThreadDefinition(): BuiltInToolDefinition {
...
export function endThreadDefinition(): BuiltInToolDefinition {
