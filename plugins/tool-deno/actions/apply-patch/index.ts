  ...
  inputSchema: {
    ...
    properties: {
      path: {
        type: "string",
        description:
          "Workspace-relative or absolute path inside the current workspace.",
      },
      operations: {
        type: "array",
        ...
        items: {
          ...
          properties: {
            ...
            oldText: {
              type: "string",
              description:
                "For 'replace': the unique substring to find. Must appear exactly once unless replaceAll is true.",
            },
            newText: {
              type: "string",
            ...
            replaceAll: {
              type: "boolean",
              description:
                "For 'replace': if true, replace every occurrence of oldText.",
            },
            anchor: {
              type: "string",
              description:
                "For 'insert_before'/'insert_after': the unique substring that marks the insertion point.",
            },
            content: {
              type: "string",
              description:
                "For 'insert_before'/'insert_after': the text to insert.",
            },
          },
          required: ["type"],
        },
