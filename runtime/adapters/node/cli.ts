...
export type StartNodeInteractiveCliOptions = Omit<InteractiveCliOptions, "io">;

/** Creates readline I/O for Node and runtimes implementing its compatibility API. */
export function createNodeInteractiveCliIo(): InteractiveCliIo {
...
export function startNodeInteractiveCli(
  options: StartNodeInteractiveCliOptions,
): InteractiveCliHandle {
  return startInteractiveCli({ ...options, io: createNodeInteractiveCliIo() });
}
