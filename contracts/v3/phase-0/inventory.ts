...
export const NATIVE_GRAPH_MUTATION_MODULES = Object.freeze([
  ...
  "runtime/knowledge/repository.ts",
] as const);
...
export const PRESERVING_TESTS = Object.freeze({
  ...
  tools:
    "runtime/tools/executor.test.ts, runtime/tools/core-plugin.test.ts",
  ...
  goals: "runtime/goals/goal.test.ts",
  usage: "runtime/usage/plugin.test.ts",
  channels:
