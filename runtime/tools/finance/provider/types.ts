...
export interface GetMarketSnapshotInput {
  symbol: string;
  include?:
    ("price" | "insights" | "key_stats" | "valuation" | "profile_summary")[];
}
...
export type ScreenSecuritiesInput =
  | ScreenSecuritiesIndexInput
  | ScreenSecuritiesEquityInput
  | ScreenSecuritiesEtfInput
  | ScreenSecuritiesMutualFundInput;
...
export type ScreenSecuritiesEquityInput =
  | ScreenSecuritiesEquityStandardInput
  | ScreenSecuritiesEquityRatiosInput
  | ScreenSecuritiesEquityFinancialsInput
  | ScreenSecuritiesEquityBalanceSheetCashFlowInput
  | ScreenSecuritiesEquityEsgOwnershipInput;
