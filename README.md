...
Copilotz 0.72 is a plugin-first, event-sourced runtime for durable AI
...
```ts
import { createCopilotz } from "jsr:@copilotz/copilotz@^0.73.0";
```
...
```ts
import { createCopilotz } from "jsr:@copilotz/copilotz@^0.73.0";
import { corePlugin, message } from "jsr:@copilotz/copilotz@^0.73.0/core";
