...
import type { AgentResource } from "../../../core/resources/agent/index.ts";
import {
  type CoreActionContext,
  coreAgent,
} from "../../../core/internal/runtime-context.ts";
import {
...
import { resolveAgentGrants } from "../../../core/internal/capabilities/grants.ts";
import {
  asRecord,
  optionalText,
  requireCollection,
  requiredText,
} from "../../../core/processors/internal/helpers.ts";
