  ...
  inputSchema: {
    ...
    properties: {
      ...
      directory: {
        type: "string",
        description:
          "Directory to search from. Defaults to the workspace root. Narrow this first.",
        default: ".",
      },
      filePattern: {
        type: "string",
        description:
          "Optional filename glob, e.g. *.ts or *.md. Always set this when you know the language.",
      },
      caseSensitive: {
        type: "boolean",
      ...
      includeAll: {
        type: "boolean",
        description:
          "Disable default directory exclusions and search everything.",
        default: false,
      },
      includeColumn: {
        type: "boolean",
